        ...
        <footer>
            <div className='upper-container'>
                ...
                <div className='contact-container'>
                    ...
                    <p><FiMail /> &nbsp;kanigantifoundation@gmail.com</p>
                    <p> <FiPhoneCall /> &nbsp;+91 91821 58737
</p>
                    <p> <TiLocation /> &nbsp;Park Residency, 54-20/9-9, G1, Timmaraju Street, Srinagar Colony, Ring Road, Vijayawada-520008</p>
                </div>
            ...
            <div className='lower-container'>
                <p>© 2021 Kaniganti-Trust. Design By Jaypee. All Rights Reserved</p>
            </div>
        </footer>
    )
}
